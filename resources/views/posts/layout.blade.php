...
<html>
    <head>
        ...
        <link href="{{ asset('css/mobileview.css') }}" rel="stylesheet">
    ...
    <body class="bg-dark flex ">
       ...
       <div  class="nav_hold">
            ...
            <div id="b2"  class="body-2 justify-content-center"> 
                ...
                @yield('content')
                <a href="{{ route('posts.index') }}" class="home py-1 px-4 text-sm text-white-600 font-semibold rounded-full border border-dark-200  hover:bg-dark-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2" >Home</a> 
